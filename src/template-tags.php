 ...
 */
function tpd_the_title_or_logo () {
 ...
 */
function tpd_the_navbar_callout () {
...
/**
 * Displays sourcecode comment block
 */
function tpd_sourcecode_flair () {
  if ($sourcecode_flair = get_theme_mod('tpd_sourcecode_flair')) {
    echo "<!-- \n" . $sourcecode_flair .  "\n -->";
  }
}