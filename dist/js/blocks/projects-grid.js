...
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__["registerBlockType"])('tpd/projects-grid', {
  ...
  edit: Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_2__["withSelect"])(function (select) {
    ...
    var onExcludedTagsChange = function onExcludedTagsChange(excludedTags) {
      setAttributes({
        excludedTags: excludedTags
      });
    };

    var onMustIncludeTagsChange = function onMustIncludeTagsChange(mustIncludeTags) {
      setAttributes({
        mustIncludeTags: mustIncludeTags
      });
    };

    var onPostCountChange = function onPostCountChange(maxPosts) {
      setAttributes({
        maxPosts: maxPosts
      });
    };
